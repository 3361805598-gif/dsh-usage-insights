...
.dshi-page{
 ...
 --dshi-accent:#17745d;--dshi-accent-soft:#edf7f3;--dshi-heat-0:#edf1f3;--dshi-heat-1:#cee8df;--dshi-heat-2:#8fc9b4;--dshi-heat-3:#459b7b;--dshi-heat-4:#176c53;--dshi-error:#b84c36;--dshi-blue:#6395ce;--dshi-purple:#a49ac7;
...
.dshi-stacked-bar{height:12px;border-radius:4px;overflow:hidden;display:flex;background:var(--dshi-soft);margin:8px 0 24px;gap:2px}.dshi-tone-input{background:var(--dshi-accent)}.dshi-tone-output{background:var(--dshi-blue)}.dshi-tone-read{background:#a3cabc}.dshi-tone-write{background:var(--dshi-purple)}.dshi-token-list>div{display:grid;grid-template-columns:1fr auto 35px;gap:8px;align-items:center;margin-top:17px;font-size:13px}.dshi-token-list>div>span:first-child{display:flex;align-items:center;gap:8px}.dshi-token-list>div>span:last-child{text-align:right}.dshi-dot{display:inline-block;width:7px;height:7px;border-radius:2px;flex-shrink:0}.dshi-reasoning{margin-top:24px;padding-top:15px;border-top:1px solid var(--dshi-line)}.dshi-reasoning>div{display:flex;justify-content:space-between;font-size:13px}.dshi-reasoning p{margin-top:7px}
